...
app.get('/ar', function (req, res) {
    ...
    device.status = req.query["s"];
    console.log("query:" + req.query["s"]);
    console.log("Client IP:" + device.ip);
    res.render('ar.html');
});
app.get('/getip', function (req, res) {
    console.log("Get ip called:" + device.ip);
    res.writeHead(200, {'Content-Type': 'text/plain'});
    res.end(device.ip);
});
app.get('/getstatus', function (req, res) {
    console.log("Get status called:" + device.status);
    res.writeHead(200, {'Content-Type': 'text/plain'});
    res.end(device.status);
});
